...
<html lang="en">
	...
	<div class="wrapper">
        ...
        <?php
            ...
            $query="SELECT itemID,itemName,itemDescription,itemPrice,itemImage,itemButton
            FROM clothing
            ORDER BY itemID";
            ...
            while ($row = mysqli_fetch_row($result)){
                ...
                $button=stripslashes($row[5]);
                echo <<<HEREDOC
				<div class = "grid">
					<div class = "$itemID">
							<h2 class="itemName">$itemName</h2>
						<p class="itemDesc">$itemDescription</p>
						<p class = "price">$itemPrice</p>
						<img class="itemImage" src = "$itemImage" height=100 alt ="Picture of item">
					</div>
				</div>
                <br>
                <br>
